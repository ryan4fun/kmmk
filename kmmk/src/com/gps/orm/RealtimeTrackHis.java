...
/**
 * RealtimeTrackHis generated by hbm2java
 */
public class RealtimeTrackHis implements java.io.Serializable {
	...
	public RealtimeTrackHis() {
	}

	public RealtimeTrackHis(long id, int vehicleId) {
		this.id = id;
		this.vehicleId = vehicleId;
	}

	public RealtimeTrackHis(long id, int vehicleId, Date recieveTime,
