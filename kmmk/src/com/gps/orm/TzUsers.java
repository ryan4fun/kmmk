...
/**
 * TzUsers generated by hbm2java
 */
public class TzUsers implements java.io.Serializable {
	...
	public TzUsers(int userId) {
		this.userId = userId;
	}

	public TzUsers(int userId, Organization organization, String loginName,
