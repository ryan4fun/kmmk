 ...
 * Author :       ttt
 *
 * Date Created : Wednesday, March 17, 2010 22:17:37
...
IF OBJECT_ID('tzUsers') IS NOT NULL
    PRINT '<<< CREATED TABLE tzUsers >>>'
ELSE
    PRINT '<<< FAILED CREATING TABLE tzUsers >>>'
go
...
ALTER TABLE tzUsers ADD CONSTRAINT Reforganization106
    FOREIGN KEY (organizationID)
    REFERENCES organization(organizationID)
go
