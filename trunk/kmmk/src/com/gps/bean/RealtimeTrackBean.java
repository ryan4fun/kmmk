...
public class RealtimeTrackBean extends AbstractBean {
	static Logger logger = Logger.getLogger(RealtimeTrackBean.class);
	...
	public RealtimeTrackBean() {
	}

	public RealtimeTrackBean(HttpServletRequest request) {
		super(request);
	}

	public List<RealtimeTrack> getList(){
		try {
			...
			List<RealtimeTrack> list = crit.list();
