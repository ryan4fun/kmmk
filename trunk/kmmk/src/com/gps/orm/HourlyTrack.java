...
/**
 * HourlyTrack generated by hbm2java
 */
public class HourlyTrack implements java.io.Serializable {
	...
	public HourlyTrack(long id, int vehicleId) {
		this.id = id;
		this.vehicleId = vehicleId;
	}

	public HourlyTrack(long id, int vehicleId, Date recieveTime,
