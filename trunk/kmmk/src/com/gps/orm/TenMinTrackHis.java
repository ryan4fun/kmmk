...
/**
 * TenMinTrackHis generated by hbm2java
 */
public class TenMinTrackHis implements java.io.Serializable {
	...
	public TenMinTrackHis() {
	}

	public TenMinTrackHis(long id, int vehicleId) {
		this.id = id;
		this.vehicleId = vehicleId;
	}

	public TenMinTrackHis(long id, int vehicleId, Date recieveTime,
